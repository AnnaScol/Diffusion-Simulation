...
folder_path = "./_data/data_sameTE_dt10";
...
folder_path = "./_data/data_sameTE_dt20";
d25 = load(sprintf('%s/final_res_Delta_25.mat',folder_path)).final_res;
d20 = load(sprintf('%s/final_res_Delta_20.mat',folder_path)).final_res;
d15 = load(sprintf('%s/final_res_Delta_15.mat',folder_path)).final_res;
d10 = load(sprintf('%s/final_res_Delta_10.mat',folder_path)).final_res;
